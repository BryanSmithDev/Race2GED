...
public class ScienceActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.science_layout);
		  ...
		  dialog.setYesButtonAction(new View.OnClickListener() {
				public void onClick(View v) {
					Intent nIntent = new Intent(Intent.ACTION_VIEW,Uri.parse("http://highered.mcgraw-hill.com/sites/0809222302/student_view0/ged_practice_test.html"));
	    ...
	    String[] mTestArray = (String[])getResources().getStringArray(R.array.science_items);
	    ...
	    list.setOnItemClickListener(new OnItemClickListener() {
	    			...
	    			int position, long id)        	
	    	  {
	    		  if (position == 0)
	    		  {
	    			  Intent nIntent = new Intent(view.getContext(), ScienceGuidelinesActivity.class);
	    			  startActivityForResult(nIntent, 0);
	    		  }
	    		  if (position == 1)
	    		  {
	    			  Intent nIntent = new Intent(view.getContext(), ScienceMultiActivity.class);
	    			  startActivityForResult(nIntent, 0);
	    		  }
	    		  if (position == 2)
	    		  {
